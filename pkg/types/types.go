...
type Backend interface {
	...
	GetSecrets(path string, version string, annotations map[string]string, options map[string]string) (map[string]interface{}, error)
	...
	GetIndividualSecret(path, secret, version string, annotations map[string]string, options map[string]string) (interface{}, error)
}
